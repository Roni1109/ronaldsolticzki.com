    ...
    <Styled_Container>
      {currentProject && (
        <div>
          ...
          <Image
            src={require(`../img/Projects/${currentProject.image}`)}
            alt={currentProject.name}
          />
          <h2>{currentProject.name}</h2>
          <h6>{currentProject.duration}</h6>
          <p>
            <Styled_Subtitle>DESCRIPTION</Styled_Subtitle>
          ...
          {currentProject.tested && currentProject.tested.length > 0 && (
            <div>
              <Styled_Subtitle>MY CONTRIBUTIONS</Styled_Subtitle>
              <ul>
          ...
          {(currentProject.bugs?.length ?? 0) > 0 && (
            <div>
              <Styled_Subtitle>BUGS IDENTIFIED</Styled_Subtitle>
              <ul>
